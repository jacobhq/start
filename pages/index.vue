          ...
          <div class="row">
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://hassio.jacobhq.xyz/" color="primary" text>Launch</v-btn>
                </v-card-actions>
              </v-card>
            </div>
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://mail.jacobhq.xyz/" color="primary" text>Launch</v-btn>
                </v-card-actions>
              </v-card>
            </div>
            <div class="col"></div>
          ...
          <div class="row">
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://github.com/" color="primary" text>Launch</v-btn>
                </v-card-actions>
              </v-card>
            </div>
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://bitbucket.org/account/signin/" color="primary" text>Launch</v-btn>
                </v-card-actions>
              </v-card>
            </div>
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://gitpod.io/" color="primary" text>Launch</v-btn>
                </v-card-actions>
              </v-card>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://classroom.google.com/u/1/h" color="primary">Launch</v-btn>
                  <v-btn depressed text href="https://classroom.google.com/u/0/h" color="primary">Launch on managed chromebook</v-btn>
                </v-card-actions>
              </v-card>
            </div>
            <div class="col">
              <v-card outlined>
                ...
                <v-card-actions>
                  <v-btn depressed href="https://drive.google.com/u/1/h" color="primary">Launch</v-btn>
                  <v-btn depressed text href="https://drive.google.com/u/0/h" color="primary">Launch on managed chromebook</v-btn>
                </v-card-actions>
              </v-card>
            </div>
          </div>
